...
#SBATCH --output=/n/lab_storage/ydu_lab/jaysonzlin/Wan2.2_edited/logs/wan_overfit_%j.out
#SBATCH --error=/n/lab_storage/ydu_lab/jaysonzlin/Wan2.2_edited/logs/wan_overfit_%j.err
...
exec singularity exec --nv \
    ...
    accelerate launch \
        ...
        training.max_train_steps=100000 \
