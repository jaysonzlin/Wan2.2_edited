...
#SBATCH --output=/net/holy-isilon/ifs/rc_labs/ydu_lab/jaysonzlin/Wan2.2_edited/logs/lingbot_%j.out
#SBATCH --error=/net/holy-isilon/ifs/rc_labs/ydu_lab/jaysonzlin/Wan2.2_edited/logs/lingbot_%j.err
...
exec singularity exec --nv \
    ...
    accelerate launch \
        ...
        'data.prompt=""' \
        logging.output_dir=outputs/i2v_lingbot_1e-5_wd0.1 \
