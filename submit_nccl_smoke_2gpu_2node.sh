...
#SBATCH --output=/n/lab_storage/ydu_lab/jaysonzlin/Wan2.2_edited/logs/nccl_smoke_2gpu_2node_%j.out
#SBATCH --error=/n/lab_storage/ydu_lab/jaysonzlin/Wan2.2_edited/logs/nccl_smoke_2gpu_2node_%j.err
...
srun \
    ...
    exec singularity exec --nv \
        ...
        exec accelerate launch \
            --config_file configs/accelerate/h200_2gpu_2node.yaml \
