#!/bin/bash
#SBATCH --job-name=joint_soft_3_deform
#SBATCH --partition=gpu_h200
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=64G
#SBATCH --time=10:30:00
#SBATCH --output=/n/lab_storage/ydu_lab/jaysonzlin/Wan2.2_edited/logs/joint_soft_3_deform_%j.out
#SBATCH --error=/n/lab_storage/ydu_lab/jaysonzlin/Wan2.2_edited/logs/joint_soft_3_deform_%j.err
...
exec singularity exec --nv \
    ...
    accelerate launch \
        ...
        objective.enable_deform_loss=true \
        logging.output_dir=outputs/joint_soft_3_deform \
