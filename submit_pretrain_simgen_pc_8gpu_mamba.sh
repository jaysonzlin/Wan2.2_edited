...
#SBATCH --job-name=pretrain_simgen_pc_8gpu_mamba
...
#SBATCH --error=/n/lab_storage/ydu_lab/jaysonzlin/Wan2.2_edited/logs/pretrain_simgen_pc_8gpu_mamba_%j.err
...
cd "${PROJECT_DIR}"
mkdir -p "logs/nccl-pretrain-simgen-pc-mamba-${SLURM_JOB_ID}"
...
export NCCL_DEBUG_FILE="${PROJECT_DIR}/logs/nccl-pretrain-simgen-pc-mamba-${SLURM_JOB_ID}/nccl.%h.%p.log"
...
echo "NCCL logs: ${PROJECT_DIR}/logs/nccl-pretrain-simgen-pc-mamba-${SLURM_JOB_ID}"
